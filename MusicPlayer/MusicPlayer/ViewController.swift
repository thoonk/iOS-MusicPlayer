...
class ViewController: UIViewController, AVAudioPlayerDelegate {
    ...
    func addPlayPauseButton(){
        let button: UIButton = UIButton() // UIButton(type: UIButton.Type.custom) custom이 없음
    ...
    func addProgressSlider(){
        ...
        let top: NSLayoutConstraint
        top = slider.leadingAnchor.constraint(equalTo: safeAreaGuide.leadingAnchor, constant: 8)
        
        let leading: NSLayoutConstraint
        leading = slider.leadingAnchor.constraint(equalTo: safeAreaGuide.trailingAnchor, constant: 16)
